...
| Context | Defines the Booking aggregate and all supporting value objects for the Cargo Booking Service. The AI agent must have processed 001_project_setup.md before this file so that package names, conventions, and dependencies are known. |
...
### Booking entity relationship to equipment lines
...
### Booking entity auditing and indexing
...
### BookingEquipmentLine entity definition
...
### BookingEquipmentLine relationship to Booking
...
### Booking reference format and generation
...
### Booking reference yearly counter
...
### Booking entity field validations
...
### BookingEquipmentLine entity field validations
...
### Items NOT covered in domain model

Tags: `domain`, `out-of-scope`
