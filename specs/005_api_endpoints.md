...
| Context | Defines the REST API contract for the Cargo Booking Service. The AI agent must have processed 001–004 so that entities, repositories, services, and conventions are known. |
...
### Create booking — request body example
...
### Get booking — response body example
...
### List bookings — query parameter validation
...
### Items NOT covered in API endpoints

Tags: `api`, `out-of-scope`
